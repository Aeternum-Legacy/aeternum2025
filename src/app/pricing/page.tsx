...
export default function Pricing() {
  ...
  return (
    <main className="page-wrapper md:gap-y-18 relative overflow-hidden">
      <img
        src="/patterns/Ellipse.png"
        alt="circle pattern"
        className="hidden md:block absolute top-[42%] left-[52%] -translate-x-1/2 -translate-y-1/2 w-[90%] h-[90%] object-contain z-0"
      />
          ...
          {activeTab === "addon" ? (
            ...
            pricingPlans.map((plan) => (
              <div key={plan.name} className="h-full">
                <div
                  className="rounded-4xl p-6 text-left flex flex-col h-full bg-no-repeat bg-cover bg-center"
                ...
                >
                  ...
                  <div className="mt-24 mb-4 border-b-2 border-[#484844]/30 w-full" />

    ...
    <main className="bg-pattern overflow-x-hidden">
      ...
      <section className="bg-[#F7F8EA] px-5 py-20 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0 w-full px-10 py-3">
          {/* Feature 1 */}
          <div className="relative flex items-center pl-9 pr-6">
            <div>
              <div className="absolute left-0 top-0 h-full w-[1px] bg-gray-300"></div>
              <div className="absolute left-0 top-1/2 -translate-y-1/2 h-24 w-[2px] bg-[#42590F]"></div>
            </div>
            <div className="flex flex-col items-start justify-center text-left py-5">
              <img
              ...
              <p className="text-sm text-[#052922] leading-4 w-80">
                ...
                intrusion. Connect with loved ones in Aeternum’s Private Family
          ...
          <div className="relative flex items-center pl-9 pr-6">
            ...
            <div className="flex flex-col items-start justify-center text-left py-5">
              ...
              <p className="text-sm text-[#052922] leading-4 w-80">
                A photo without a story is just a snapshot in time. Aeternum
                keeps your cherished memories into lasting legacies by pairing
                images and videos with personal stories, voice recordings, and
          ...
          <div className="relative flex items-center pl-9 pr-6">
            ...
            <div className="flex flex-col items-start justify-center text-left py-5">
              ...
              <p className="text-sm text-[#052922] leading-4 w-80">
                ...
                and wisdom you pass down. With Aeternum’s proprietary design,
                you can securely share your life’s story and ensure it reaches
